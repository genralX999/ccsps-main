...
(async function(){
	...
	document.getElementById('showAll').addEventListener('change', async () => {
		// clear user selection when toggling showAll off/on
		// do not force change, user may still select specific user
		await fetchTable(1);
	});
